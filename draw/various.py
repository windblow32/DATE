...
def draw_cd_diagram(df_perf=None, alpha=0.4, title=None, labels=False):
    """
    ...
    plt.savefig('/Users/ovoniko/Documents/GitHub/EntityMatching/ruleMining/draw/critical/cd-diagram.png',
                bbox_inches='tight')


def wilcoxon_holm(alpha=0.4, df_perf=None):
    """
